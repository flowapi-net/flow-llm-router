...
from flow_llm_router.api.auth import router as auth_router
from flow_llm_router.api.caller_tokens import router as caller_tokens_router
from flow_llm_router.api.dashboard import router as dashboard_router
...
logger = logging.getLogger("flow_llm_router")
    ...
    if static_dir.exists() and any(static_dir.iterdir()):
        ...
        async def spa_fallback(full_path: str):
            ...
            if page_html.is_file():
                return FileResponse(page_html, headers=html_headers)
