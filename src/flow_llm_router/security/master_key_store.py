"""Persist and load Flow LLM Router's vault master key for auto-unlock."""
...
from flow_llm_router.config import Settings


def resolve_master_key_path(settings: Settings) -> Path:
    """Resolve the configured master-key path."""
    configured = settings.security.master_key_path or "~/.flow_llm_router/master.key"
