...
class SmartRouterConfig:
    ...
    # Flow LLM Router monkey-patches routellm.routers.similarity_weighted.utils.OPENAI_CLIENT
...
class SecurityConfig:
    ...
    master_key_path: str = "~/.flow_llm_router/master.key"
...
def load_settings(config_path: str | None = None) -> Settings:
    ...
    search_paths = [
        ...
        Path.cwd() / "flow_llm_router.yaml",
        Path.cwd() / "flow_llm_router.yml",
    ]
    ...
    if "security" in raw:
        ...
        settings.security = SecurityConfig(
            ...
            master_key_path=sec.get("master_key_path", "~/.flow_llm_router/master.key"),
